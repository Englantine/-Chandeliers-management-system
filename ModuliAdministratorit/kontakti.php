							...
							<p style="text-align:right;">Përshëndetje, <em><?php  echo $Qasja_perdoruesit;?>!</em></p>
									<form action="" method="post">  
										...
										<tr>
											...
											<td>
											<input type="text" name="fjale" placeholder="Subjektin ose Emailin" value="%"/>
											</td>
									...
									($lidh_Kont,$_REQUEST['fjale']);     
									$sql = mysqli_query($lidh_Kont,
									"CALL kerkoKontakte('$fjale')"); 
									while($rreshti = mysqli_fetch_array($sql)) { 		
											echo "<tr>";
											echo "<td>".$rreshti['Subjekti']."</td>";
											echo "<td>".$rreshti['Mesazhi']."</td>";
											echo "<td>".$rreshti['Email']."</td>";	
											echo "<td><a href=\"fshi_Kontakt.php?Id_kontaktuesi=$rreshti[Id_kontaktuesi]\" onClick=\"return confirm('A jeni te sigurt se deshironi te fshini Kontaktin?')\"  class='button primary'>Fshij</a>
											</td></tr>";			
										}
