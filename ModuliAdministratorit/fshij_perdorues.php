			...
			<div id="wrapper">
				...
				<!-- Main -->
					...
					<section id="content" class="main">
							...
							<table class="alt">
							<tr>
								<h3>Kerko te dhenat e perdoruesit per fshirje</h3>
							</tr>
							<tr>
								<td>Shkruaj:</td>
								...
								<?php
									if(!empty($_REQUEST['fjale'])) {
										...
										while($rreshti=mysqli_fetch_array($sql)) {
											...
											echo "<td><a href=\"fshiPerdorues.php?Id_Perdoruesi=$rreshti[Id_Perdoruesi]\" onClick=\"return confirm ('A jeni te sigurt se deshironi ta fshini perdoruesin?')\" class='button primary'>Fshij</a></td>";
											echo "</tr>";
										}
									}
								?>
